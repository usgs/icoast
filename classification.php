...
//          var maxImageHeight = windowHeight - 25 - headerHeight - footerHeight - annotationHeight;
          var maxImageHeight = windowHeight - 50 - headerHeight - annotationHeight;
    ...
    <div id="wrapper">
      ...
      <div id="images">
        ...
        <div id="imageColumnLeft" class="imageColumn">
          <div id="preNavigationHeader">
            <span class="icon-drop-down leftDropArrow" ></span>
            <p>Pre-Storm Coastal Navigator</p>
          </div>
