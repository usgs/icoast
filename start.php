...
$bodyHTML = <<<EOL
        ...
        <p>Random</p>
          <button class="clickableButton formButton" type="button" id="randomButton"><img src="images/system/dice.png"></button>
        </div>
        <div class="postNavButtonWrapper">
          <p>Map</p>
          <button class="clickableButton formButton" type="button" id="mapButton"><img src="images/system/map.png"></button>
        </div>
