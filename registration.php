...
//    $validCredentials = false;
    $errorMessage['otherCrowdType'] = 'You must type your "Other Crowd Type" if "Other" is selected in the crowd type list.';
      ...
      <form method="post" action="registration.php" id="registerForm">
        ...
        <div class="formFieldRow">
          ...
          if (isset($errorMessage['crowdType'])) {
            print '<label class="error" for="registerCrowdType">' . $errorMessage['crowdType'] . '</label>';
          }
          ?>
        </div>
        <div class="formFieldRow" id="registerOtherRow">
          ...
          if (isset($errorMessage['otherCrowdType'])) {
            print '<label class="error" for="registerCrowdType">' . $errorMessage['otherCrowdType'] . '</label>';
          }
          ?>
          ...
          if (isset($errorMessage['affiliation'])) {
            print '<label class="error" for="registerCrowdType">' . $errorMessage['affiliation'] . '</label>';
          }
          ?>
                 </div>
