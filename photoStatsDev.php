...
<?php
print $jsPhotoLocationLatitude;
print $jsPhotoLocationLongitude;
print $jsTargetPhotoId;
print $jsTargetProjectId;
?>
...
<?php
print $jsphotoLocationMapCode;
print $jsPhotoMatchesMapCode;
print $jsAllProjectMatchesMapCode;
?>
            ...
            <div id="adminContentWrapper">
                ...
                <div>
                    ...
                    <form method="get" autocomplete="off" id="photoSelectionForm" action="#photoSelectHeader">
                        ...
                        <input type="textbox" id="analyticsPhotoIdTextbox" class="formInputStyle" name="targetPhotoId" <?php print $photoSelectTextValue ?>>
                        <input type="submit" id="userIdSubmit" class="clickableButton" value="Select Photo">
                    </form>
                    <?php
                    print $photoSelectClearFormHTML;
                    print $photoDetailsHTML;
                    print $photoMatchDetailsHTML;
                    print $photoMatchesMapWrapperHTML;
                    print $allProjectMatchesMapWrapperHTML;
                    ?>
                </div>
            </div>
        </div>
