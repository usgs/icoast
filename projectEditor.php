...
<?php
if (isset($_POST['projectId'])) {
    print "var projectId = {$_POST['projectId']};\n\r";
}
if (isset($_POST['projectPropertyToUpdate'])) {
    print "var propertyToUpdate = '{$_POST['projectPropertyToUpdate']}';\n\r";
}
?>
...
if (isset($javascriptGroupOrderInParentTask)) {
    print 'var groupOrderInTaskData = ' . $javascriptGroupOrderInParentTask . ';';
}
if (isset($javascriptGroupOrderInParentGroup)) {
    print 'var groupOrderInGroupData = ' . $javascriptGroupOrderInParentGroup . ';';
}
if (isset($javascriptTagOrderInParentGroup)) {
    print 'var tagOrderInGroupData = ' . $javascriptTagOrderInParentGroup . ';';
}
?>
...
<?php if (isset($javascriptGroupOrderInParentTask)) { ?>
...
<?php print $projectUpdateErrorHTML ?>
                </div>
                <div id="actionSelectWrapper">
<?php print $actionSelctionHTML ?>
                </div>
                <div id="actionControls">
<?php print $actionControlsHTML ?>
                </div>
                <div id="actionSummary">
<?php print $actionSummaryHTML ?>
                </div>
            </div>
        </div>
